...
- Hub a intensità (vedi `HUB.md`, `PLACE.md`, `ART.md`): radura arancio, nastro grigio con bordo neon, coni colorati, faro a strisce, cupola e silhouette di A/B/C, Arena, Belvedere. Stesso seme `hashText('Mondo-1')`
